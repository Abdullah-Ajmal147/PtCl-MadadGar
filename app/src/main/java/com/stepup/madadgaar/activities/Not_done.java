...
public class Not_done extends AppCompatActivity {
    ImageView Button_nav;
    DrawerLayout mdrawerlayout;
    TextView txthome,aboutUs,ContacUs,Logout,btn_Retry_button,txt_SubCategory,txt_NotDone_Name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_SubCategory=findViewById(R.id.txt_Not_SubCategory);
        txt_NotDone_Name=findViewById(R.id.txt_NotDone_Name);
        btn_Retry_button=findViewById(R.id.btn_Retry_button);
        ...
        txt_NotDone_Name.setText(abc);
        txt_SubCategory.setText(CateGoryName);

        btn_Retry_button.setOnClickListener(new View.OnClickListener() {
            @Override
